...
class SvImportAttributeNode(SverchCustomTreeNode, bpy.types.Node):
    """
    Triggers: GIS import
    ...
    """
    bl_idname = 'SvImportAttributeNode'  # should be add to `sverchok/index.md` file
...
def register():
        bpy.utils.register_class(SvImportAttributeNode)

def unregister():
        bpy.utils.unregister_class(SvImportAttributeNode)