...
COMMITS_LINK = 'https://github.com/Marcus-Richmond/sverchok-gis-nodes/commits'
ADDON_NAME = sverchok_gis.__name__
ADDON_PRETTY_NAME = 'Sverchok GIS Nodes'
...
class SvO3PreferencesClass(AddonPreferences):
...
def register():
    bpy.utils.register_class(SvO3PreferencesClass)
    bpy.types.SV_PT_SverchokUtilsPanel.append(sv_draw_update_menu_in_panel)

def unregister():
    bpy.utils.unregister_class(SvO3PreferencesClass)
